 ...
 */
void irqInit(void) {
  // TODO probably better in port code
  uint32_t max_irqn =
  ...
  nvicEnableVector(EXTI5_9_IRQn, STM32_IRQ_EXTI5_9_PRIORITY);
  nvicEnableVector(EXTI10_15_IRQn, STM32_IRQ_EXTI10_15_PRIORITY);
#endif
}
